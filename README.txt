...
Topic:              Goal of this web application is to create videogame react-app where user can search and visualize game data, see related pictures to the game and see related game trailer. Each of these may get their own view and data context will be shared between components using context hook. Pictures related to game could be gallery of gameplay scenes. Video will be atleast trailer to game and possibly some gameplay as well. I plan on using atleast steam (https://developer.valvesoftware.com/wiki/Steam_Web_API?ref=apilist.fun) and twitch (https://dev.twitch.tv/docs?ref=apilist.fun) apis.
